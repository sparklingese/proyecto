    ...
    <form runat="server">
        <header>
            <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
                ...
                <asp:Button ID="btnreporte" BorderColor="White" ForeColor="White" class="btn btn-outline-success my-2 my-sm-0" type="submit" runat="server" Text="Submit a Report" OnClick="btnreporte_Click" />
                ...
                <asp:Button ID="btnusuario" BorderColor="White" ForeColor="White" class="btn btn-outline-success my-2 my-sm-0" type="submit" runat="server" Text="Users" OnClick="btnusuario_Click" />
        ...
        <div class="jumbotron bg-info rounded-circle">
            <div class="container well contenedor bg-info text-white">
                <h1 class="bg-dark">Welcome Manager!</h1>
                ...
                <p>
                    <asp:Button ID="btnrepo" runat="server" Text="Send a Report Now!" CssClass="form-control btn btn-dark" OnClick="btnrepo_Click1" /></p>
            </div>
        </div>
