...
<body class="bg-info">
    ...
    <form runat="server">
        ...
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark ">
            ...
            <asp:Button ID="btnInicio" BorderColor="White" ForeColor="White" class="btn btn-dark btn-outline-light text-info my-2 my-sm-0" type="submit" runat="server" Text="Home" OnClick="btnInicio_Click" />
        ...
        <div>
            ...
            <asp:Button ID="Button5" runat="server" CssClass="btn btn-dark" Text="Delete solved tasks" OnClick="Unnamed5_Click" />
            <asp:Button ID="Button6" runat="server" CssClass="btn btn-dark" Text="Delete unsolved tasks" OnClick="Unnamed6_Click" />
        </div>
