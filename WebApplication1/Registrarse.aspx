...
<body class="bg-info">
    <div class="container well contenedor">
		<div class="row">
			<div class="col-xs-12">
				<h2 class="bg-dark text-white">Registrarse</h2>
			</div>
		</div>
		<form id="form1" runat="server" class="form-horizontal">
			...
			<div class="form-group">
				<asp:Button ID="btnIngresar" runat="server" Text="Ingresar" ForeColor="White" CssClass="form-control btn btn btn-dark" OnClick="Unnamed1_Click" />
				<br />
				<asp:Literal ID="alerta" runat="server" Text=""></asp:Literal>
			</div>
			<div class="form-group">
				<asp:Button ID="btnInicio" runat="server" Text="Ir a Iniciar Sesión" CssClass="form-control btn btn-primary " OnClick="btnInicio_Click" />
			</div>
