     ...
     <form runat="server">
         <header>
             <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                 ...
                 <asp:Button ID="btninicio" BorderColor="White" ForeColor="White" class="btn btn-outline-light text-info my-1 my-sm-0" type="submit" runat="server" Text="Home" OnClick="btninicio_Click" />
                 <asp:Button ID="btnreporte" BorderColor="White" ForeColor="White" class="btn btn-outline-light text-info my-1 my-sm-0" type="submit" runat="server" Text="Submit Report" OnClick="btnreporte_Click" />
        ...
        <div class="jumbotron bg-info rounded-circle">
            <div class="container well contenedor bg-info text-white">
                ...
                <p>
                    <asp:Button ID="btnrepo" runat="server" Text="Send your Report Now!" CssClass="form-control btn btn-dark btn-outline-light text-info" OnClick="btnrepo_Click1" /></p>
            </div>
        </div>
