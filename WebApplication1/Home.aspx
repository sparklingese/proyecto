...
<body class="bg-info">
    <form id="form1" runat="server">
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
            ...
            <asp:Button ID="btnSesion" BorderColor="White" ForeColor="white" class="btn btn-outline-success my-2 my-sm-0" type="submit" runat="server" Text="Sign In" OnClick="btnISesion_Click" />
            <asp:Button ID="btnRegistro" BorderColor="White" ForeColor="white" class="btn btn-outline-success my-2 my-sm-0" type="submit" runat="server" Text="Sign Up" OnClick="btnRegistro_Click" />
        ...
        <div class="jumbotron bg-info rounded-circle">
            <div class="container well contenedor bg-info text-white">
                <h1 class="bg-dark">¡Welcome to Techport!</h1>
                ...
                <p>
                    <asp:Button ID="btnregi" runat="server" Text="Sign Up Now!" CssClass="form-control btn btn-dark" OnClick="btnregi_Click1" /></p>
            </div>
        </div>
